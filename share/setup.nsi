...
OutFile CannabisCoin-0.8.6.1-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Litecoin.lnk" $INSTDIR\CannabisCoin-qt.exe
    ...
    WriteRegStr HKCR "CannabisCoin" "" "URL:Litecoin"
